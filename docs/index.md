...
- [AI: MusicSpec (canonical musical intent)](./ai/music-spec.md)
- [AI: Cadence types (beyond common-practice)](./ai/cadence-types.md)
- [AI: Tonal centroid vs Spiral Array](./ai/tonal-centroid-vs-spiral-array.md)
- [AI: Authoring theory cards](./ai/theory-card-authoring.md)
- [AI: Extending the music theory KB](./ai/extending-music-theory-kb.md)
- [Release](./release.md)
