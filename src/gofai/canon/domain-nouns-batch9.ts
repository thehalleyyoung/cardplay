...
const SEQUENCE: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'sequence' },
...
const IMITATION: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'imitation' },
...
const INVERSION: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'inversion' },
...
const RETROGRADE: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'retrograde' },
...
const AUGMENTATION: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'augmentation' },
...
const DIMINUTION: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'diminution' },
...
const EMBELLISHMENT: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'embellishment' },
...
const PASSING_TONE: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'non-chord-tone', type: 'passing' },
...
const NEIGHBOR_TONE: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'non-chord-tone', type: 'neighbor' },
...
const ESCAPE_TONE: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'non-chord-tone', type: 'escape' },
...
const ANTICIPATION: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'non-chord-tone', type: 'anticipation' },
...
const SUSPENSION: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'non-chord-tone', type: 'suspension' },
...
const RETARDATION: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'melody', device: 'non-chord-tone', type: 'retardation' },
...
const PEDAL_POINT: MelodyLexeme = {
  ...
  category: 'noun',
  semantics: { type: 'concept', domain: 'harmony', device: 'pedal-point' },
